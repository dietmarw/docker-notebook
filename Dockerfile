...
RUN cp -L /etc/letsencrypt/live/jupyter.dwe.no/fullchain.pem /home/student/letsencrypt/
RUN cp -L /etc/letsencrypt/live/jupyter.dwe.no/privkey.pem /home/student/letsencrypt/
